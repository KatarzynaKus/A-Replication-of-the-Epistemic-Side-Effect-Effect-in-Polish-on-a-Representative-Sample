...
# Metadata
attributes(esee)$label <- "Replication of the Epistemic Side‑Effect Effect – Polish sample"
...
metadata(esee)$identifier         <- "TODO: DOI HERE"   
metadata(esee)$citation           <- "Zaręba M. et al. (2025). Replication of the Epistemic Side‑Effect Effect in Polish on a Representative Sample. *OSF*."
